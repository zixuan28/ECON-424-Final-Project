...
set.seed(123)
Sharpe.boot.EWS = computeSEconfintSharpe(ret.mat[, "EWS", drop=FALSE], risk.free)
Sharpe.boot.EWY = computeSEconfintSharpe(ret.mat[, "EWY", drop=FALSE], risk.free)
Sharpe.boot.EWT = computeSEconfintSharpe(ret.mat[, "EWT", drop=FALSE], risk.free)
Sharpe.boot.EWH = computeSEconfintSharpe(ret.mat[, "EWH", drop=FALSE], risk.free)
...
The annual sharpe ratio of each asset are all lower than that of the sharpe ratio of the tangent portfolio. It is impressive that the tangency portfolio beats the annual sharpe ratio of individual assets.
